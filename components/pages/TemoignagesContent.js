  ...
  return (
    <main className="relative min-h-screen pt-40 pb-24">
      <div className="container">
        ...
        <Reveal>
          <div className="mb-16">
            <div className="text-xs uppercase tracking-[0.2em] text-inkSoft mb-6">Témoignages vidéo · placeholders</div>
            <div className="grid md:grid-cols-2 gap-5">
              {[1, 2].map((i) => (
                <div key={i} className="relative aspect-video rounded-[28px] overflow-hidden glass-strong flex items-center justify-center group cursor-pointer">
                  <div className="absolute inset-0 bg-gradient-to-br from-brownLight/30 via-sand/40 to-taupe/30" />
                  <div className="relative flex flex-col items-center gap-3">
                    <div className="h-16 w-16 rounded-full glass-strong flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                      <Play className="h-6 w-6 text-terracotta ml-1" fill="currentColor" />
                    </div>
                    <div className="text-xs text-inkSoft">Vidéo témoignage · sera remplacée</div>
                  </div>
                </div>
              ))}
            </div>
